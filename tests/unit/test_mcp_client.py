...
from police_peer.infrastructure import mcp_client as mc
...
def test_httpx_status_error_is_peer_unavailable(monkeypatch) -> None:
    ...
    was still crashing the process even after the ReadTimeout fix."""
